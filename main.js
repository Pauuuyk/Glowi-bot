...
conn.bye = '-------------------------------------------------\n┣・🧸 @user\n┣・🧸𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏 𝙏𝙀 𝙃𝘼𝘾𝙀 𝙇𝘼 𝘾𝙊𝙍𝘿𝙄𝘼𝙇 𝘿𝙀𝙎𝙋𝙀𝘿𝙄𝘿𝘼 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊, 𝙃𝘼𝙎𝙏𝘼 𝙋𝙍𝙊𝙉𝙏𝙊🧸❤\n\n┣・ *𝙔𝘼 𝙉𝙊 𝙁𝙊𝙍𝙈𝘼𝙎 𝙋𝘼𝙍𝙏𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊*\n┣・ *𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏*\n-------------------------------------------------'
conn.spromote = '❗ *𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀  @user 𝙀𝙎 𝙐𝙉 𝙉𝙐𝙀𝙑𝙊 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏*'
conn.sdemote = '❗ *𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 @user 𝙔𝘼 𝙉𝙊 𝙀𝙎 𝙐𝙉 𝘼𝘿𝙈𝙄𝙉 𝘿𝙀𝙇 𝙂𝙍𝙐𝙋𝙊\n\n*𝙔𝘼 𝙉𝙊 𝙏𝙄𝙀𝙉𝙀𝙎 𝙇𝙊𝙎 𝙋𝙊𝘿𝙀𝙍𝙀𝙎 𝘿𝙀 𝘼𝘿𝙈𝙄𝙉 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏*'
conn.sDesc = '❗ *𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n ✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏✅\n*𝙉𝙐𝙀𝙑𝘼 𝘿𝙀𝙎𝘾𝙍𝙄𝙋𝘾𝙄𝙊𝙉:* @desc'
conn.sSubject = '❗ *𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙀𝙇 𝙉𝙊𝙈𝘽𝙍𝙀 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏✅\n*𝙉𝙐𝙀𝙑𝙊 𝙉𝙊𝙈𝘽𝙍𝙀:* @subject'
conn.sIcon = '❗ *𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏* 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙈𝙊𝘿𝙄𝙁𝙄𝘾𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n\n*✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏✅*'
conn.sRevoke = '*❗𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏 𝘼𝙉𝙐𝙉𝘾𝙄𝘼 𝙌𝙐𝙀 𝙎𝙀 𝙃𝘼 𝘼𝘾𝙏𝙐𝘼𝙇𝙄𝙕𝘼𝘿𝙊 𝙀𝙇 𝙇𝙄𝙉𝙆 𝘿𝙀 𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊\n\n✅𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊 𝙃𝙔𝙋𝙀𝙍´𝙑 𝘽𝙊𝙏✅\n*𝙉𝙐𝙀𝙑𝙊 𝙇𝙄𝙉𝙆:* @revoke'
...
setInterval(async () => {
  ...
  const bio = `𝙂𝙇𝙊𝙒𝙄 𝘽𝙊𝙏 CREADO POR +51 936732723
DURANTE: ${uptime}`;
